...
if(!class_exists('APIAndroidAppAmauri'))
{
    class APIAndroidAppAmauri {
		...
		public function read($id) {
			...
			// youtube
			$content = preg_replace('/<iframe.*?(?!src).*?src=[\'|"](https?:)?(\/\/)?(www\.)?(youtu\.be\/|youtube(-nocookie)?\.[a-z]{2,4}(?:\/embed\/|\/v\/|\/watch\?.*?v=))([\w\-]{10,12})([\?|&]?.*?)?[\'|"][^>]+><\/iframe>/g', '<a href="https://www.youtube.com/watch?v=$6"><img src="http://img.youtube.com/vi/$6/0.jpg" /><br/><b>Voir la vidéo</b><br/></a>', $content);
